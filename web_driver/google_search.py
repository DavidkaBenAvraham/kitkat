...
class GoogleHtmlParser():
    """Google HTML Parser.
    https://github.com/aluf-computers/htmlparsers/tree/master/htmlparsers
    ...
    """
    user_agent : str = attrib(init = False , default = 'desktop')
    tree : html = attrib(init = False , default = None)


    def __attrs_post_init__(self, user_agent : str =  'desktop' , *args, **kwrads) -> None:
