...
SYSTEM_GENERATE_VERSION = "taobao-sdk-python-20220404"
...
def sign(secret, parameters):
    ...
    if hasattr(parameters, "items"):
        ...
        parameters = "%s%s%s" % (secret,
            ...
            secret)
    sign = hashlib.md5(str(parameters).encode('utf-8')).hexdigest().upper()
    return sign
...
class RestApi(object):
    ...
    # Rest api的基类
    #===========================================================================
    __domain : str = attrib(init = False , default=None)
    __port : int = attrib(init = False , default=None)
    __httpmethod : str = attrib(init = False , default=None)
    __app_key : str = attrib(init = False , default=None)
    ...
    def __attrs_post_init__(self):
        ...
        #      @param port: 请求的端口
        #=======================================================================
        _params : dict = json.loads(ini.paths.apis_file)['aliexpress']
        self.__domain = _params['domain']
        self.__port = _params['port']
        self.__httpmethod = _params['httpmethod']
    ...
    def getMultipartParas(self)->list:
        return [];

    def getTranslateParas(self)->dict:
        return {};
    ...
    def getResponse(self, authrize=None, timeout=30):
        ...
        jsonobj = json.json.loads(result)
    ...
    def getApplicationParameters(self):
        ...
        #prior_args = ', '.join(
        #    [f'{k}={v}' for k, v in zip(self.__dict__.keys(), self.__dict__.values()])
